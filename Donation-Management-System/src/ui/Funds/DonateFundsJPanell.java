 ...
 * @author Raushan
 */
public class DonateFundsJPanell extends javax.swing.JFrame {

    /**
     * Creates new form DonateFundsJPanell
     */
    ...
    public DonateFundsJPanell(EcoSystem ecosystem, Network network, Enterprise enterprise, JPanel jPanel, UserAccount userAccount) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonateFundsJPanell.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new DonateFundsJPanell().setVisible(true);
            }
        });
    }
    ...
    private void populateOrg() {
        ...
        for(Enterprise enterprise : network.getEnterpriseDirectory().getEntList()){
            if(enterprise.getEntType().toString().equals(Enterprise.EntType.DonationEntDirectory.getValue())){
                for(Organization org : enterprise.getOrgDirectory().getOrgList()){
